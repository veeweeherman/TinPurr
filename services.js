...
console.log('HELLOOOOOOOO SERVCIES');
			return $http({
				method: 'GET',
				url:'https://query.yahooapis.com/v1/public/yql',
				query: "select * from flickr.photos.search where has_geo='true' and tags='funny cats' and api_key='c4f57fcf22dcb4274f71bbacc7550f0c'",
				format:'json',
